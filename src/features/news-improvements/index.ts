...
export default async(): Promise<void> => {
  ...
  document.body.classList.add(Constants.Styles.NewsImprovements.featureJs, Constants.Styles.NewsImprovements.featureStyle);
  
  allConcurrently('News Improvements', [ 
