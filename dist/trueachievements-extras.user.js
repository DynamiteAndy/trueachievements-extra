...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.extractBetween = exports.yesterday = exports.today = exports.staffWalkthroughPagePreviewPage = exports.staffWalkthroughPreviewPage = exports.staffWalkthroughPage = exports.staffManageWalkthroughPage = exports.staffEditWalkthroughPage = exports.achievementsPage = exports.achievementPage = void 0;
...
},{"../config":1,"../constants":2,"../regex":4,"../styles/staff-walkthrough-improvements":16,"./helpers/html-element-util":7,"./helpers/template":9,"./helpers/wait":10}],14:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../constants":2,"../scripts/helpers/wait":10}],16:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
    ...
    const observer = new MutationObserver(function (mutations) {
        mutations.forEach(function (mutation) {
            if (mutation.type === 'attributes' && mutation.attributeName === 'data-theme') {
                iframe.contentWindow.postMessage({ theme: mutation.target.dataset.theme }, '*');
                document.body.setAttribute('data-ta-x-theme', mutation.target.dataset.theme);
            }
        });
    });
